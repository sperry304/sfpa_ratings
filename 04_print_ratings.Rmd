...
match_dates <-
  c(as_date("2019-07-23"), fall_2019_games %>% filter(match_type == "regular") %>% select(match_date) %>% distinct() %>% arrange() %>% pull())
...
Data sources: Spring 2018-Fall 2019 SFPA seasons, Spring 2019 SFPA 8-ball tournament, Spring 2019 Slate 8-ball tournament, 2016-2019 Slate Saturday night tournaments, 2016-2019 Happy singles tournaments
