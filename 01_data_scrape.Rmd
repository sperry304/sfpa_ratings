...
new_data_urls <- str_c("https://www.sfpapool.org/stats/week/", 77:79) # Most recent week
...
new_matches <- 
  read_csv("tournaments/spring2019_slate8ball.csv") %>% 
...
saveRDS(all_matches_2019springplayoffs, "match_data/all_matches_2019spring.Rdata")
```
