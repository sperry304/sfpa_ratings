...
More importantly, it is clear from a conceptual standpoint that each game can provide useful information about more than the two players involved. If player A beats player B this week and player B beat player C last week, then this week we learned something about player C. The Elo system ignores this information while Bradley-Terry uses it to update our best guess of player C's skill level.
