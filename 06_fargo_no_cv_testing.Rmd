...
param_list <- list(
  as_of_match_date = date_loop, gamma_prior = 2.75, half_life_days = 1500, 
...
saveRDS(fargo_df, "other_data/fargo_324.Rdata")
```
...
plot_multiple_player_ratings(player_list = c("Jesse La Fear", "Nick Callado", "Stefano Lopez"), fargo_df)
```
